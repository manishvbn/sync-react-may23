...
class EventComponent extends Component {
    ...
    // Never create Arrow Function as Class Members (Will increase Memory Usage)
    handleClick9 = (e) => {
        console.log("event: ", e);
        console.log("this: ", this);
        e.preventDefault();
        ...
        return (
            <div>
                ...
                <div className="mt-2">
                    ...
                    }>Click Five - Function Expression</a>
                </div>
                <div className="mt-2">
                    <a href="https://www.google.com" onClick={
                        (function (e) {
                    ...
                    }>Click Six - Function Expression Binded</a>
                </div>
                <div className="mt-2">
                    <a href="https://www.google.com" onClick={
                        (e) => {
                ...
                <div className="mt-2">
                    <a href="https://www.google.com" onClick={this.handleClick9}>Click Nine - Wrong Usage</a>
                </div>
            </div>
        );
    }
